...
command! -bang -nargs=* -complete=file AgFromSearch call ag#AgFromSearch('grep<bang>', "<bang>", <q-args>)
...
command! -bang -nargs=* -complete=file AgFile call ag#Ag('grep -g', "<bang>", <q-args>)
